...
const POLICY_SECTIONS: PolicySection[] = [
  {
    ...
    purpose: 'How BabyLog collects, uses, stores, and protects family and child-related data.',
    points: [
      ...
      'Parent/guardian data ownership: baby data belongs to the parent or legal guardian, not BabyLog.',
  ...
  },
  {
    ...
    purpose: 'Rules for using BabyLog and responsibilities of account holders.',
    points: [
      ...
      'BabyLog is provided as-is for care tracking support; users remain responsible for real-world care decisions.',
      'Limitation of liability: BabyLog is not liable for losses resulting from reliance on app suggestions, missed entries, or service interruptions.',
    ],
  },
  {
    ...
    points: [
      'BabyLog does not provide medical diagnosis, treatment, or emergency intervention.',
  ...
  },
  {
    ...
    points: [
      'BabyLog is intended for adults (parents/guardians/caregivers), not direct use by children.',
  ...
  },
  {
    ...
    points: [
      ...
      'BabyLog does not sell baby or family personal data.',
  ...
  },
  {
    ...
    points: [
      ...
      'Auditability: BabyLog may log who created or modified records to support accountability.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'BabyLog may moderate, restrict, or remove violating content and accounts.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      'BabyLog is not an emergency response tool.',
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-bold leading-relaxed text-text-dim">
                These policies define how BabyLog protects child-related records, supports multi-user care
                workflows, and communicates medical and AI limitations. By using BabyLog, users agree to these
                policy terms.
              </p>
