...
<body>
  ...
  <div style="margin-top: 60px; padding-top: 20px; border-top: 1px solid #e2e8f0; text-align: center; color: #64748b; font-size: 11px;">
    <p>This document is an electronic health record generated by Cradlyn Premium.</p>
  </div>
...
<body>
  <section class="hero">
    <div class="eyebrow">Cradlyn Visit Packet</div>
  ...
  <div class="footer">
    Cradlyn visit packet · This summary is intended to support, not replace, direct clinical review.
  </div>
