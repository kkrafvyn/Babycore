...
<body>
  ...
  <div style="margin-top: 60px; padding-top: 20px; border-top: 1px solid #e2e8f0; text-align: center; color: #64748b; font-size: 11px;">
    <p>This document is an electronic health record generated by Bud & Bloom Premium.</p>
  </div>
...
<body>
  <section class="hero">
    <div class="eyebrow">Bud & Bloom Visit Packet</div>
  ...
  <div class="footer">
    Bud & Bloom visit packet · This summary is intended to support, not replace, direct clinical review.
  </div>
