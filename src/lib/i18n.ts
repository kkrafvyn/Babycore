...
const translations: Record<string, Translations> = {
  en: {
    ...
    payment: {
      ...
      secureNotice:
        'Your financial credentials are tokenized and processed via high-fidelity secure gateways. Serenity never retains raw payment data.',
    ...
    onboarding: {
      ...
      countryNoMatchBody: 'Try a country name, code, or region keyword.',
  ...
  es: {
    ...
    payment: {
      ...
      secureNotice:
        'Sus credenciales financieras están tokenizadas y procesadas a través de pasarelas seguras. Serenity nunca retiene datos de pago sin procesar.',
