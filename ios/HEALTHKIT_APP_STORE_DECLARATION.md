...
> Apple Health access is optional and user initiated. A caregiver opens Wearables, taps Sync Apple Health, reviews the in-app disclosure, and then approves HealthKit read permissions. BabyLog uses the imported readings only inside the baby's care records, summaries, reminders, and timeline.
...
- BabyLog reads only the categories listed above.
